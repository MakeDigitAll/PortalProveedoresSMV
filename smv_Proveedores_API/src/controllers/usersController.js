...
const getWaitingUsers = async (req, res) => {
  try {
    ...
    res.status(400).json({ error: 'Error al obtener al usuario' });
  }
}
//----------------------------------------------------------------------------------------
...
const createUser = async (req, res) => {
  try {
    ...
    const newUser = await pool.query('INSERT INTO "userAuth" ("userName", "password") VALUES ($1, $2) RETURNING *', [email, password])
