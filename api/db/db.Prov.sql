...
--alter table "providerProductsAvailability"
--add constraint fk_availability_prod foreign key ("productId") references "providerProducts" ("id");

--alter table "providerOrders"
--add constraint fk_orders_provider foreign key ("providerId") references "providersProfile" ("id");

--alter table "providerOrders"
--add constraint fk_orders_user foreign key ("userId") references "users" ("id");

--alter table "providerOrders"
--add constraint fk_orders_product foreign key ("productId") references "providerProducts" ("id");
